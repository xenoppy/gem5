	.file	"single_dpu_message_asy.cpp"
	.text
.Ltext0:
	.file 0 "/home/weichu/my_gem5/gem5/pimtest/single_dpu_message_asy" "single_dpu_message_asy.cpp"
...
.LC4:
	.string	"dpu_init done"
.LC5:
	.string	"RED"
.LC6:
	.string	"dpu_load done"
.LC7:
	.string	"dpu_work done"
	.text
	.globl	main
	.type	main, @function
main:
.LFB3354:
	.file 3 "single_dpu_message_asy.cpp"
	.loc 3 7 1
	.cfi_startproc
...
.LEHB0:
	...
	movq	%rax, %rsi
	movl	$16, %edi
	call	_Z21dpu_init_asynchronousiPcS_@PLT
	.loc 3 11 9
	leaq	.LC4(%rip), %rax
	movq	%rax, %rdi
	call	puts@PLT
...
.LEHE1:
	.loc 3 12 24 is_stmt 0 discriminator 2
	leaq	-64(%rbp), %rax
	movq	%rax, %rdi
.LEHB2:
	call	_Z21dpu_load_asynchronousNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEE@PLT
.LEHE2:
	.loc 3 12 24 discriminator 4
	leaq	-64(%rbp), %rax
	movq	%rax, %rdi
...
.LEHB3:
	...
	.loc 3 14 26
	movl	$1, %edi
	call	_Z23dpu_launch_asynchronousN9upmem_sim17dpu_launch_policyE@PLT
	.loc 3 15 9
	leaq	.LC7(%rip), %rax
	movq	%rax, %rdi
	call	puts@PLT
...
.LLSDACSB3656:
	.uleb128 .LEHB4-.LFB3656
	.uleb128 .LEHE4-.LEHB4
	.uleb128 .L23-.LFB3656
	.uleb128 0
	.uleb128 .LEHB5-.LFB3656
	.uleb128 .LEHE5-.LEHB5
	.uleb128 0
	.uleb128 0
.LLSDACSE3656:
...
.LASF396:
	.string	"insert"
.LASF808:
	.string	"_Z23dpu_launch_asynchronousN9upmem_sim17dpu_launch_policyE"
.LASF153:
...
.LASF812:
	.string	"_Z21dpu_init_asynchronousiPcS_"
.LASF268:
...
.LASF306:
	.string	"iterator"
.LASF807:
	.string	"dpu_launch_asynchronous"
.LASF663:
	.string	"strtoul"
.LASF281:
	.string	"_M_construct"
...
.LASF810:
	.string	"_Z21dpu_load_asynchronousNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEE"
.LASF214:
...
.LASF0:
	.string	"single_dpu_message_asy.cpp"
.LASF1:
	.string	"/home/weichu/my_gem5/gem5/pimtest/single_dpu_message_asy"
